// all data assembled in data variable.
const loadProducts = () => {
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <p>Rating given by: ${product.rating.count}</p>
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success">add to cart</button>
      <button onclick="showModal()" id="details-btn" class="btn btn-danger">Details</button>
      </div>
      `;
...
// details button working part.
const showModal = () => {
  alert('this part is optional for this assignment.');
}

// buy button working part. 
